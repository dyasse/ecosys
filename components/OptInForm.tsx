...
export default function OptInForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="opt-in-form" noValidate>
      ...
      {/* GDPR consent — required if you have EU visitors */}
      <div className="consent-row">
        <label className="consent-label">
          ...
          />
          <span>
            I agree to receive helpful emails from [Brand Name], including my free guide and
            occasional pattern updates. I can unsubscribe at any time.
          </span>
        </label>
      </div>
